...
export function VisualSettings(props: VisualProps) {
    return (
        <div>
            ...
            <Checkbox
                defaultChecked={props.defaultShowArrows}
                boxStyle='box'
                onChange={props.onChangeShowArrows}
...
export function AlgorithmSettings(props: AlgorithmProps) {
    return (
        <div>
            ...
            <Checkbox
                defaultChecked={props.defaultAlg}
                boxStyle='box'
                disabled={props.disabled}
                onChange={props.onChangeBidirectional}
            >
                Bidirectional
            </Checkbox>
        </div>
    ...
    return (
        <div>
            ...
            <RadioButtonGroup
                ...
                disabled={props.disabled}
                onChange={[
                    props.onClickManhattan, props.onClickEuclidean,
                    props.onClickChebyshev, props.onClickOctile
                ]}
            >
